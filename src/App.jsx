  ...
  return (
    <div style={stylesMain}>
      <div className="container">
        <h1
          style={{ borderBottom: "1px solid #f1f1f1", paddingBottom: "20px" }}
        >
        ...
        <p style={stylesPera}>To install the package, use npm:</p>
      </div>
      <div style={{ width: "80%", margin: "auto" }}>
        <pre style={precode}>
          <p>npm i responsive-navigation</p>
        </pre>
        <div
          style={{
            background: "#f1f1f1",
        ...
        >
          <MegamenuLive />
          <div style={markdowncode} dangerouslySetInnerHTML={description}></div>
        </div>
      </div>
    </div>
  );
